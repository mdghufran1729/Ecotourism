...
const AddressPage = (  ) => {
  ...
  return (
    <div id='pg'>
      <div id='box'>
    <Box className="bx">
      <h2 id='head'>Enter your Address</h2>
      <form  onSubmit={handleSubmit}>
        ...
        <Button onClick={handleClick} isDisabled={isAddressEmpty} title={isAddressEmpty ? tooltipMessage : ''} _disabled={{ cursor: 'not-allowed' }} className='button' type="submit" >
          Next
        </Button>
      </form>
    </Box>
